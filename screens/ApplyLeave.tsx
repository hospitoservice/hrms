...
const { annualLeaveBalance, annualLeaveLabel, leaveTypes, staffingWarning } = leaveData;
    ...
    <div className="flex flex-col min-h-screen bg-background-light dark:bg-background-dark">
      ...
      <main className="flex-1 p-4 space-y-6">
        ...
        <div className="flex items-center justify-between p-5 rounded-xl bg-blue-50 dark:bg-blue-900/20 border border-blue-100 dark:border-blue-900/30">
          <div>
            <h2 className="text-xl font-bold text-primary dark:text-blue-400">{annualLeaveBalance} days</h2>
